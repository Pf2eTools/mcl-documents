...
def build_2026_bolton():
    LUA = ""
    tactics_deck = build_deck_from_dir("../assets/2026/bolton/tactics", back_url=tactics_back_url)
    LUA += deck_to_lua_str(tactics_deck)

    attachments_deck = build_deck_from_dir("../assets/2026/bolton/attachments")
    LUA += deck_to_lua_str(attachments_deck)

    ncu_deck = build_deck_from_dir("../assets/2026/bolton/ncu")
    LUA += deck_to_lua_str(ncu_deck)

    units_deck = build_deck_from_dir("../assets/2026/bolton/units")
    LUA += deck_to_lua_str(units_deck)

    return LUA


def build_2026_stark():
    LUA = ""
    tactics_deck = build_deck_from_dir("../assets/2026/stark/tactics", back_url=tactics_back_url)
    LUA += deck_to_lua_str(tactics_deck)

    attachments_deck = build_deck_from_dir("../assets/2026/stark/attachments")
    LUA += deck_to_lua_str(attachments_deck)

    ncu_deck = build_deck_from_dir("../assets/2026/stark/ncu")
    LUA += deck_to_lua_str(ncu_deck)

    units_deck = build_deck_from_dir("../assets/2026/stark/units")
    LUA += deck_to_lua_str(units_deck)
...
def main():
    ...
    bolton_lua = build_2026_bolton()
    build_decks_lua(bolton_lua, "../lua/bolton-decks.lua")
    build_spawn_decks_json("bolton-decks", "spawn-bolton-decks-button.json")

    stark_lua = build_2026_stark()
    build_decks_lua(stark_lua, "../lua/stark-decks.lua")
    build_spawn_decks_json("stark-decks", "spawn-stark-decks-button.json")
